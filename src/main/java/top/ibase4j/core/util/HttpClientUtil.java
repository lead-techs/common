...
import top.ibase4j.core.support.http.builder.HCBuilder;
import top.ibase4j.core.support.http.common.HttpConfig;
import top.ibase4j.core.support.http.common.HttpMethods;
import top.ibase4j.core.support.http.common.Utils;
...
public class HttpClientUtil {
    ...
    static {
        try {
            clientHTTP = HCBuilder.custom().build();
            clientHTTPS = HCBuilder.custom().ssl().build();
    ...
    private static HttpResponse execute(HttpConfig config) throws HttpProcessException {
        ...
        try {
            ...
            Utils.errorException("请求异常: " + config.url(), e);
